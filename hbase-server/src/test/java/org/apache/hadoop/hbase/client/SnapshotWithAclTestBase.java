...
public abstract class SnapshotWithAclTestBase extends SecureTestUtil {
  ...
  public static void setupBeforeClass() throws Exception {
    ...
    conf.set(HConstants.SNAPSHOT_RESTORE_FAILSAFE_NAME, "hbase-failsafe-{snapshot.name}-{restore.timestamp}");
  ...
  public void testRestoreSnapshot() throws Exception {
    ...
    assertEquals(0,  TEST_UTIL.getAdmin().listSnapshots(Pattern.compile(snapshotName1)).size());

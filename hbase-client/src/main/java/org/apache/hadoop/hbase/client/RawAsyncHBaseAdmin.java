                ...
                addListener(internalRestoreSnapshot(failSafeSnapshotSnapshotName, tableName,
                  restoreAcl, null), (void3, err3) -> {
                    if (err3 != null) {
                      ...
                      // If fail to restore snapshot but rollback successfully, delete the restore-failsafe snapshot.
                      ...
                      addListener(deleteSnapshot(failSafeSnapshotSnapshotName), (ret4, err4) -> {
                        if (err4 != null) {
                          LOG.error("Unable to remove the failsafe snapshot: {}", failSafeSnapshotSnapshotName, err4);
                        }
